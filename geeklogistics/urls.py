...
urlpatterns = patterns('',
                       ...
                       url(r'^poi/psw/$', 'geeklogistics.views.poi_psw', name='poi_psw'),
                       ...
                       url(r'^order/success/(?P<deliver_id>\d+)/$', 'geeklogistics.views.order_success',
                           name='order_success'),
                       ...
                       url(r'^station/list/(?P<station_id>\d+)/$', 'geeklogistics.station.views.order_list',
                           name='order_list'),

                       # 配送员相关
                       url(r'^api/v1/dispatcher/login$', 'geeklogistics.deliver.views.dispatcher_login',
                           name='dispatcher_login'),
                       url(r'^api/v1/dispatcher/password$', 'geeklogistics.deliver.views.dispatcher_change_password',
                           name='dispatcher_change_password'),
                       url(r'^api/v1/driver/login$', 'geeklogistics.deliver.views.driver_login', name='driver_login'),
                       url(r'^api/v1/driver/password$', 'geeklogistics.deliver.views.driver_change_password',
                       ...
                       url(r'^api/v1/order/updateStatus$', 'geeklogistics.order.views.update_order_status',
                           name='update_order_status'),
                       url(r'^api/v1/order/delete$', 'geeklogistics.order.views.order_delete', name='order_delete'),
                       url(r'^api/v1/order/detail$', 'geeklogistics.order.views.order_detail_ajax',
