...
class Order(models.Model):
	...
	poi_nearest = models.ForeignKey(Station, verbose_name="商家最近取货站点", null=True, blank=True)
	customer_nearest = models.ForeignKey(Station, verbose_name="收货人最近站店", null=True, blank=True)
